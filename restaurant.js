export const db = [
    ...
    listsDish: [
      {
        ...
        price: 11.9,
        description:
          "Saumon, marinade, oignons, cornichons, ... merci de voire la photo pour le reste",
  ...
  },
  {
    ...
    description:
      "Un kebab dans un pain nan? Pourquoi personne n'y a pensé avant?",
    promo: "",
    distance: 2.6,
    fee: "0.99 delivery",
    note: 4.0,
    ...
    listsDish: [
      {
        ...
        price: 12.99,
        description:
          "Sauce tomate, mozza, basilic et champis de Paris",
    ...
    listsDish: [
      {
        ...
        price: 8,
        description:
          "Viande haché, Balls raclette, sauce sweet onions gatiné raclette",
    ...
    listsDish: [
      {
        ...
        price: 8,
        description:
          "Nems, oignons, crudités, menthe et coriandre,vermicelles et cacahuètes",
      ...
      },
      {
        ...
        price: 7,
        description:
          "Recette street food spicy mayo, poulet sauté, crudités, concombre, coriandre, oignons",
    ...
    listsDish: [
      {
        ...
        price: 9,
        description:
          "3 chocolatines (je vois déjà les pro pains au chocolat s'énerver) et 3 croissants",
  ...
  },
  {
    ...
    listsDish: [
      ...
      },
      {
        ...
        price: 7,
        description:
          "Bagel avec poulet au curry, aubergines grillées et coulis de miel",
  ...
  },
  {
    ...
    description:
      "À La Fabrique du Sushi, votre restaurant japonais, goûtez à de nombreuses préparations minutes, faites maison, réalisées avec amour, soin et attention",
    ...
    listsDish: [
      {
        ...
        price: 12.5,
        description:
          "Riz vinaigré, thon, avocat, carottes, edamamé, tomates cerise, algues wakame et graines de sésame",
      ...
      },
      {
        ...
        price: 13.5,
        description:
          "Riz vinaigré, poulet pané, avocat, carottes, edamamé, tomates cerise, algues wakame et graines de sésame",
  ...
  },
  {
    ...
    description:
      "Notre restaurant dépend des produits de saison, notre carte est établie en fonction de l’arrivage du marché",
    promo: "",
    distance: 1.93,
    fee: "15.0 delivery",
    note: 5,
    ...
    listsDish: [
      {
        ...
        price: 7,
        description:
          "1 Smoothie pomme banane kiwi de 25 cL, 1 pancake caramel beurre salé et 1 salade de fruits de saison bio et locaux.",
      ...
      },
      {
        ...
        price: 8.5,
        description:
          "1 Jus d’orange clémentine de 25 cL, 1 pancake pâte à tartiner et 1 salade de fruits de saison bio et locaux.",
      ...
      },
      {
        ...
        price: 10.5,
        description:
          "Miel, cacahuètes, caramel maison, poudre d'amande, sucre, beurre, œuf bio plein air",
      ...
      },
      {
        ...
        price: 9.9,
        description:
          "1 Jus d’orange clémentine de 25 cL, 1 pain au chocolat pur beurre et 1 salade de fruits de saison bio et locaux",
    ...
    listsDish: [
      {
        ...
        price: 5.75,
        description:
          "Deux mini-viennoiseries artisanales provenant de la boulangerie Tout Autour du Pain (Meilleur croissant IDF 2015), une salade de fruits maison et un jus d'oranges fraichement pressées",
        url: require("./assets/images/restos/energique.jpg"),
        popular: true,
      },
      {
        ...
        price: 9.75,
        description:
          "Retrouvez le bon goût des pommes dans un jus 100% naturel, 100% fait maison, réalisé grâce à un extracteur de jus",
        url: require("./assets/images/restos/Jus.jpg"),
        popular: true,
      },
      {
        ...
        price: 14.0,
        description:
          "Le cake orange, ou comment mordre dans un cake à pleines dents ! Doux et savoureux, si vous aimez les agrumes, laissez-vous séduire par ce goût fruité et légèrement acidulé... ",
        url: require("./assets/images/restos/Cake.jpg"),
        popular: true,
      },
      {
        ...
        price: 9.95,
        description:
          "Le saviez-vous, les soeurs Tatin se sont aussi déclinées en cake. Les pommes sont cuites à coeur pour délivrer leur croquant et leur arôme. Les pommes fondantes sauront vous faire fondre complètement",
        url: require("./assets/images/restos/PommeCa.jpg"),
        popular: true,
      },
      {
        ...
        price: 12.0,
        description:
          "Notre jus de raisin blanc est réalisé à la commande grâce à un extracteur de jus. Cette technique permet de conserver toutes les vitamines et la vitalité du raisin pour délivrer le jus le plus frais et le plus savoureux.",
        url: require("./assets/images/restos/JusRai.jpg"),
        popular: true,
      },
    ],
  },

  {
    ...
    description:
      "Les petits-déjeuners d’Instant-Lunch, adaptés à tous goûts et tous les appétits",
    ...
    listsDish: [
      {
        ...
        price: 10.9,
        description:
          "1 mini pain au chocolat, 1 mini croissant,1 madeleine maison,1 verrine de fruits frais",
        url: require("./assets/images/restos/forConf.jpg"),
        popular: true,
      },
      {
        ...
        price: 14.9,
        description:
          "Café en grain 1L, 5 sachets – Thé prestige Compagnie Coloniale, Chocolat chaud à l’ancienne 50cL, Jus d’orange pressé 1L, Smoothies frais 1L",
        url: require("./assets/images/restos/petitDejePrest.jpg"),
        popular: true,
      },
    ],
  },
    ...
    listsDish: [
      {
        ...
        price: 5.9,
        description:
          "1 x croissant ou pain au chocolat, 1 x pomme, 1 x jus d'orange pressé par nos soins, 25cl",
        url: require("./assets/images/restos/DejParisien.jpg"),
        popular: true,
      },

      {
        ...
        price: 10.3,
        description:
          "1 x croissant ou pain au chocolat, 1 x pomme, 1 x muffin au chocolat,1 x jus Sweet Kiss (orange, pomme passion) pressé par nos soins - 25cl",
        url: require("./assets/images/restos/PdejParisien.jpg"),
        popular: true,
      },
      {
        name: "Rehab - 25cl",
        price: 4.9,
        description:
          "Concombre, chou kale, pomme, citron Pressé dans nos bars à jus",
        url: require("./assets/images/restos/kubrick.jpg"),
        popular: false,
      },
    ],
  },

  {
    ...
    description:
      "Depuis plus de 25ans nous préparons au Dong Huong, ce qui peut-être considéré comme les meilleurs Bo-bun & Pho de Paris",
    promo: "Spend €20, get 5% off",
    distance: 1.8,
    fee: "2.99 delivery",
    note: 5,
    ...
    listsDish: [
      {
        ...
        price: 10.2,
        description:
          "Soupe tonkinoise spéciale.Tonkinese special soup (big or small)",
      ...
      },
      {
        ...
        price: 12.1,
        description:
          "Soupe aux crevettes Tonkinese soup with shrimps",
      ...
      },
      {
        ...
        price: 11.5,
        description:
          "Brochette de bœuf & vermicelles Grilled beef skewer & vermicelli",
      ...
      },
      {
        ...
        price: 14.5,
        description:
          "Brochettes de crevettes grillées & galettes de riz",
